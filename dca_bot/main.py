...
def main() -> None:
    ...
    # Reconciliation: die kann Kaeufe nachtragen, ein Abgleich davor
    # verglicher also gegen einen veralteten Ledger-Stand. Und er liegt
    # bewusst in dieser Liste statt in einem eigenen try/except - so gilt
    # der W18-Schutz auch fuer ihn (Stufe 2, Punkt 3, siehe
    # startup_checks.py).
